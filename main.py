...
HEALTH_FONT = pygame.font.SysFont('comicsans', 40) #Defining size and font
...
def yellow_handle_movement(keys_pressed, yellow):
        if keys_pressed[pygame.K_a] and yellow.x - VEL > 0: #LEFT KEY
            yellow.x -= VEL    
        if keys_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x: #RGHT KEY
            yellow.x += VEL
...
def red_handle_movement(keys_pressed, red):
        if keys_pressed[pygame.K_LEFT] and red.x - VEL > BORDER.x + BORDER.width: #LEFT KEY
            red.x -= VEL    
        if keys_pressed[pygame.K_RIGHT] and red.x + VEL + red.width < WIDTH: #RGHT KEY
            red.x += VEL 
